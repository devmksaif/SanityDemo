...
export default function GetStartedButton({
  ...
  return (
    <div className="inline-block">
      <button
        className={cn(
          "group flex h-12 min-w-40 items-center justify-center gap-3 rounded-lg bg-amber-100 px-4 py-2 font-bold transition-colors duration-100 ease-in-out hover:bg-orange-600",
          className,
        )}
      >
        <span
          className={cn(
            "text-orange-600 transition-colors duration-100 ease-in-out group-hover:text-amber-100 whitespace-nowrap",
          )}
        >
          {text}
        </span>
