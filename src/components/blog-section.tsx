...
const BlogSection = ({
  ...
  const posts: Post[] = articles.map(article => ({
    ...
    image: article.coverImage ? urlFor(article.coverImage).width(700).height(400).url() : "https://deifkwefumgah.cloudfront.net/shadcnblocks/block/placeholder-dark-1.svg",
  }));
