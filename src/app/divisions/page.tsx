    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden py-20 sm:py-32 bg-muted">
        <div className="absolute inset-0 opacity-50">
          <div className="absolute -top-32 left-0 w-96 h-96 bg-primary/10 rounded-full blur-3xl" />
          <div className="absolute -bottom-32 right-0 w-96 h-96 bg-secondary/10 rounded-full blur-3xl" />
        </div>
